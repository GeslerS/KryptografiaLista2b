...
public class Main {
	public static void main(String[] args) {
		/*
		 * Rozwiazanie: Klucz 35aa3cdf290b7b3d 
		 * Tekst  "Is it better or worse to listen to music while you work? What about white noise?"
		 */
		...
		String pierwszaCzescKlucza = "00000000";
